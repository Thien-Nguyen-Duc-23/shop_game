$(document).ready(function() {
    ...
    $('#createCardProvider').on('click', function () {
        ...
        var html = `
            ...
            <div class="form-group">
                <label class="col-form-label" for="card-provider-name">Tên nhà cung cấp<span class="text-danger">*</span></label>
                <input type="text" class="form-control" id="card-provider-name" value="" placeholder="Tên nhà cung cấp">
            </div>
            <div class="form-group">
                    ...
                    success: function (data) {
                        if (data.error === 0) {
                            var html = `
                                ...
                                <div class="form-group">
                                    <label class="col-form-label" for="card-provider-name">Tên nhà cung cấp<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="card-provider-name" value="${data.cardProvider.name}" placeholder="Tên nhà cung cấp">
                                </div>
                                <div class="form-group">
                                    <label class="col-form-label" for="card-provider-rate">Tỉ lệ chiết khấu</label>
                                    <input type="number" class="form-control" id="card-provider-rate" value="${data.cardProvider.rate}" placeholder="Tỉ lệ chiết khấu">
                                </div>
                            `;
                            $('#notication').html(html);
                        } else {
    ...
    $('#btn-submit').on('click', function () {
        ...
        $.ajax({
            ...
            type: 'post',
            data: {id: id, name: name, rate: rate, action: action, _token: _token},
            dataType: 'json',
            beforeSend: function(){
                var html = '<div class="text-center"><div class="vong-xoay"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div>';
                $('#btn-submit').attr('disabled', true);
