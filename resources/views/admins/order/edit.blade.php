            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        value="{{ $order->partner_rate ? number_format($order->partner_rate,0,",",".") : old('partner_rate') }}"
                    >
                    @error('partner_rate')
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        value="{{ old('banking_code', $order->banking_code) }}" 
                    >
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        name="buyer_note" 
                        placeholder="Vui lòng nhập mã ngân hàng" 
                        value="{{ old('buyer_note', $order->buyer_note) }}" 
                    >
                    @error('name')
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row g-3">
                    <div class="col-12 col-lg-4">
                        ...
                        <input 
                            ...
                            name="unit_price" 
                            value="{{ old('unit_price', $order->unit_price ? number_format($order->unit_price,0,",",".") : null) }}"
                            min=1
                            required
                        >
                    ...
                    <div class="col-12 col-lg-4">
                        ...
                        <input 
                            ...
                            name="discouted" 
                            value="{{ old('discouted', $order->discouted ? number_format($order->discouted,0,",",".") : null) }}"
                        >
                        <p hidden class="mt-2 form-label text-danger font-weight-normal error-order-max-value"></p>
                        @error('discouted')
                ...
                <div class="mb-3">
                    ...
                    <input 
                        ...
                        id="total" 
                        placeholder=""
                        value="{{ $order->total ? number_format($order->total,0,",",".") : old('total') }}"
                        disabled
                    >
                    <input hidden name="total" value="{{ $order->total ? number_format($order->total,0,",",".") : old('total') }}" id="total-temp">
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table mb-3" id='table-order-infor'>
                    ...
                    <tbody>
                        @if (!empty($order->order_infos))
                            @foreach ($order->order_infos as $orderInfo) 
                            <tr>
                                <td><input type="text" name='name[]' placeholder='Vui lòng nhập tên' class="form-control" value="{{ $orderInfo->name }}" /></td>
                                <td><input type="text" name='content[]' placeholder='Vui lòng nhập nội dung' class="form-control" value="{{ $orderInfo->content }}"/></td>
...
@section('scripts')
    ...
    <script>
        ...
        var processorId = {!! $order->processor_id !!};
    </script>
@endsection
