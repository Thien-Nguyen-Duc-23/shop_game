...
@endsection
@section('title')
    Quản lý khách tiếp thị liên kết
@endsection
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.home') }}"><i class="bx bx-home-alt"></i> Trang chủ</a></li>
    <li class="breadcrumb-item active" aria-current="page">Nhóm khách tiếp thị liên kết</li>
@endsection
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-3">
                    <a href="{{ route('admin.refer.create') }}" class="btn btn-primary px-5"><i
    ...
    <div class="modal fade" id="modal-page" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" id="refer-form" name="refer-form" class="form-horizontal">
                    <div class="modal-body">
                        <input type="hidden" name="id" id="refer-id" value="">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-danger" id="btn-submit-refer" data-bs-dismiss="modal">Hoàn
                            thành</button>
                    </div>
                </form>
            </div>
