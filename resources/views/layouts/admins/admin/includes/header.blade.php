        ...
        <div class="user-box dropdown">
            <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="user-info ps-3">
                    <p class="user-name mb-0">{{ Auth::user()->last_name }} {{ Auth::user()->first_name }}</p>
                    <p class="designattion mb-0">{{ Auth::user()->role }}</p>
                </div>
            </a>
            <ul class="dropdown-menu dropdown-menu-end">
{{--                <li><a class="dropdown-item" href="javascript:;"><i class="bx bx-user"></i><span>Profile</span></a></li>--}}
                <li><a class="dropdown-item" href="{{ route('admin.system_config') }}"><i class="bx bx-cog"></i><span>Thiết lập hệ thống</span></a></li>
