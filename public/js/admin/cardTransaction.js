...
/*!***********************************************!*\
  !*** ./resources/js/admin/cardTransaction.js ***!
  \***********************************************/
$(document).ready(function () {
  ...
  function listPage() {
    $.ajax({
      url: '/admin/card-transaction/get-list-card-transaction',
  ...
  function screen_list(data) {
    ...
    $.each(data.data.data, function (index, cardTransaction) {
      html += '<tr>';
      // user
      html += '<td>' + cardTransaction.userName + '</td>';
      // // Nội dung
      html += '<td>' + cardTransaction.cardProviderName + '</td>';
      html += '<td>' + cardTransaction.serial + '</td>';
      html += '<td>' + cardTransaction.code + '</td>';
      html += '<td>' + cardTransaction.value + '</td>';
      html += '<td>' + cardTransaction.real_value + '</td>';
      html += '<td>' + cardTransaction.real_cash + '</td>';
      html += '<td>' + cardTransaction.status + '</td>';
      html += '</tr>';
    });
    $('tbody').html(html);
    // phân trang cho vps
  ...
  // function confirmDeleteCardProvider(cardProviderId){
  //     var isConfirmed = confirm('Bạn có chắc muốn xoá nhà cung cấp này không??');

  //     if (isConfirmed) {
  //         $.ajax({
  //             url: "/admin/card-provider/delete/" + cardProviderId,
