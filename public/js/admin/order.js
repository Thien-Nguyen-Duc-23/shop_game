...
$(document).ready(function () {
  ...
  function screen_list(data) {
    ...
    $.each(data.data['data'], function (index, order) {
      ...
      html += '<td>' + order.total.toLocaleString('it-IT', {
        style: 'currency',
        currency: 'VND'
      }) + '</td>';
  ...
  function totalPrice() {
    ...
    var price = (_$$val = $('#unit-price').val()) !== null && _$$val !== void 0 ? _$$val : 0;
    var quantity = (_$$val2 = $('#quantity').val()) !== null && _$$val2 !== void 0 ? _$$val2 : 0;
    var discounted = (_$$val3 = $('#discounted').val()) !== null && _$$val3 !== void 0 ? _$$val3 : 0;
    if (price && quantity) {
