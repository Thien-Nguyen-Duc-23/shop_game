...
$(document).ready(function () {
  ...
  function screen_list(data) {
    ...
    $.each(data.data.data, function (index, product) {
      ...
      html += '<td>' + product.pricing.toLocaleString('it-IT', {
        style: 'currency',
        currency: 'VND'
      }) + '</td>';
      html += '<td>' + product.sale_pricing.toLocaleString('it-IT', {
        style: 'currency',
        currency: 'VND'
      }) + '</td>';
      html += '<td>' + product.card_pricing.toLocaleString('it-IT', {
        style: 'currency',
        currency: 'VND'
      }) + '</td>';
      ...
      if (isConfirmed) {
        $.ajax({
          ...
          error: function error(_error) {
            console.error("Lỗi xoá sản phẩm: ", _error);
          }
        });
      }
    }
